...
*/
    ...
    for (var pagetype of ['tickets', 'staff', 'hardware', 'software', 'global_metrics']) {
...
gulp.task('plugins', function() {
    ...
    gulp.src(['assets/js/plugins/jquery.js', 'assets/js/plugins/jquery-ui.js', 'assets/js/plugins/jquery-timepicker-addon.js', 'assets/js/plugins/popper.js', 'assets/js/plugins/bootstrap.js', 'assets/js/plugins/bootstrap-select.js'])
        .pipe(plumber())
        .pipe(sourcemaps.init())
